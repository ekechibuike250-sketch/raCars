...
const HomeHeroComponent = () => {
    return (
        <section className="feature pt-20 md:pt-7 md:pb-7 bg-ink h-dvh md:h-[80dvh] relative" style={{
            backgroundImage: `linear-gradient(to top,
            rgba(11, 13, 15, 0.9),
            rgba(23, 26, 29, 0.5)),url(${heroBackgroundImage})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',
        }}>
